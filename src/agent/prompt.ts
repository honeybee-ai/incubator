/**
 * System prompt generation — shared parts from SDK, incubator-specific extensions here.
 */

import type { ToolDef } from './types.js';

// Re-export from SDK
export { ACP_KNOWLEDGE, generateSystemPrompt as _generateSystemPromptBase } from '@honeybee-ai/hivemind-sdk/agent';

import { ACP_KNOWLEDGE } from '@honeybee-ai/hivemind-sdk/agent';
 ...
 * Incubator version supports bootstrap negotiation for multi-agent spec creation.
 */
...
// ─── Incubator-specific: Bootstrap negotiation prompts ──────────────
